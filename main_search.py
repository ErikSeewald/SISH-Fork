...
def run(slide_path="./DATA/WSI", latent_path="./DATA/LATENT", site=None,
    ...
    for latent_path in tqdm(glob.glob(latent_all)):
        ...
        slide_path = os.path.join(slide_path, anatomic_site, diagnosis,
...
if __name__ == "__main__":
    ...
    run(args.slide_path, args.latent_path, args.site, args.db_index_path,
